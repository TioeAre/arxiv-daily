<details>
  ...
  <ol>
    <li><a href=#visual-localization>Visual Localization</a></li>
      <ul>
        <li><a href=#Revisiting-Medical-Image-Retrieval-via-Knowledge-Consolidation>Revisiting Medical Image Retrieval via Knowledge Consolidation</a></li>
      </ul>
    </li>
    <li><a href=#nerf>NeRF</a></li>
      <ul>
        <li><a href=#Hybrid-Rendering-for-Multimodal-Autonomous-Driving:-Merging-Neural-and-Physics-Based-Simulation>Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation</a></li>
      </ul>
    </li>
  </ol>
</details>
...
### [Revisiting Medical Image Retrieval via Knowledge Consolidation](http://arxiv.org/abs/2503.09370)  
...
### [Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation](http://arxiv.org/abs/2503.09464)  
Máté Tóth, Péter Kovács, Zoltán Bendefy, Zoltán Hortsin, Balázs Teréki, Tamás Matuszka  
<details>  
  <summary>Abstract</summary>  
  <ol>  
