<details>
  ...
  <ol>
    <li><a href=#visual-localization>Visual Localization</a></li>
      <ul>
        <li><a href=#Towards-a-general-purpose-foundation-model-for-fMRI-analysis>Towards a general-purpose foundation model for fMRI analysis</a></li>
      </ul>
    </li>
  </ol>
</details>
...
### [Towards a general-purpose foundation model for fMRI analysis](http://arxiv.org/abs/2506.11167)  
